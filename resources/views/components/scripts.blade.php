...
<link rel="stylesheet" href="{{ url(mix('/cookie-consent.js', '/vendor/cookie-consent')) }}">
...
<script>
    cookieconsent.run({
        ...
        languages: @json(collect(config('cookie-consent.locales'))->mapWithKeys(function ($locale) {
            return [
                $locale => [
                    'consent_modal' => [
                        ...
                        'description' => sprintf('%s <button type="button" data-cc="c-settings" class="cc-link">%s</button>',
                            __('cookie-consent::texts.consent_bar.description', [], $locale),
                    ...
                    'settings_modal' => [
                        ...
                        'blocks' => collect([
                            ...
                            'cookie_table' => collect($category['cookies'])->map(fn ($cookie) => [
                                'col1' => $cookie['name'],
                                'col2' => config('app.url'),
